...
BEGIN
	...
	PRINT '删除表：[dbo].[Dim_Date]';
END
GO
CREATE TABLE [dbo].[Dim_Date]
    (
     [DateKey] INT NOT NULL
	,[DateKeyOfCNWeekName] NVARCHAR(20)
    ,[FullDateAlternateKey] DATETIME
	--年
    ,[CalendarYear] INT
    ,[DayNumberOfYear] SMALLINT
	--半年
    ,[CalendarSemesterNumberOfYearCode] NVARCHAR(10)
    ,[CalendarSemesterNumberOfYear] TINYINT
    ,[CalendarENCalendarSemesterOfYear] NVARCHAR(10)
    ,[CalendarCNCalendarSemesterOfYear] NVARCHAR(10)
	--季度
    ,[CalendarQuarterNumberOfYearCode] INT
    ,[CalendarQuarterNumberOfYear] TINYINT
    ,[CalendarENQuarterNameOfYear] NVARCHAR(10)
    ,[CalendarCNQuarterNameOfYear] NVARCHAR(10)
	,[CalendarCNQuarterNameOfYear_II] NVARCHAR(10)
	--月份
    ,[CalendarMonthNumberOfYearCode] INT
    ,[CalendarMonthNumberOfYear] TINYINT
    ,[CalendarENMonthNameOfYear] NVARCHAR(10)
    ,[CalendarENMonthShortNameOfYear] NVARCHAR(10)
    ,[CalendarCNMonthNameOfYear] NVARCHAR(10)
	,[CalendarCNMonthNameOfYear_II] NVARCHAR(10)
	,[CalendarMonthNameOfYear] NVARCHAR(10)
    ,[PeriodOfTenDays] NVARCHAR(10)
    ,[DayNumberOfMonth] TINYINT
	--周
    ,[CalendarWeekNumberOfYearCode] INT
    ,[CalendarWeekNumberOfYear] TINYINT
    ,[CalendarCNWeekNameOfYear] NVARCHAR(10)
    ,[DayNumberOfWeek] TINYINT
    ,[IsWeekend] NVARCHAR(10) DEFAULT ( '平时' )
    ,[ENDayNameOfWeek] NVARCHAR(10)
    ,[ENDayShortNameOfWeek] NVARCHAR(10)
    ,[CNDayNameOfWeek] NVARCHAR(10)
    ,[IsYesterdayId] INT
...
CREATE UNIQUE CLUSTERED INDEX [CIX_Dim_Date_01] ON [dbo].[Dim_Date]
(
	[DateKey] ASC
...
ALTER TABLE [dbo].[Dim_Date] ADD CONSTRAINT PK_Dim_Date_DateKey PRIMARY KEY([DateKey])
GO
