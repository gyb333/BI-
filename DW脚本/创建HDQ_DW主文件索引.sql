...
BEGIN
	...
	ALTER DATABASE [BI_HDQ_DW] REMOVE FILE [PF_PRIMARY_Index01];
END
GO
...
BEGIN
	...
	ALTER DATABASE [BI_HDQ_DW] REMOVE FILE [PF_PRIMARY_Index02];
END
GO
...
BEGIN
	...
	ALTER DATABASE [BI_HDQ_DW] REMOVE FILE [PF_PRIMARY_Index03];
END
GO
...
BEGIN
	...
	ALTER DATABASE [BI_HDQ_DW] REMOVE FILE [PF_PRIMARY_Index04];
END
GO
...
BEGIN
	...
	ALTER DATABASE [BI_HDQ_DW] REMOVE FILE [PF_PRIMARY_Index05];
END
GO
/*
索引文件组
...
BEGIN
	ALTER DATABASE [BI_HDQ_DW] REMOVE FILEGROUP [FG_PRIMARY_Index]
END
GO
...
索引文件组
*/
ALTER DATABASE [BI_HDQ_DW] ADD FILEGROUP [FG_PRIMARY_Index]
GO
...
创建索引文件
*/
ALTER DATABASE [BI_HDQ_DW] ADD
FILE (
	NAME = 'PF_PRIMARY_Index01',
	FILENAME = 'D:\BIDatabases\PRIMARY_Indexs_HDQ\PF_PRIMARY_Index01.NDF',
	SIZE = 2048MB,
	FILEGROWTH = 512MB
...
FILE (
	...
	FILENAME = 'D:\BIDatabases\PRIMARY_Indexs_HDQ\PF_PRIMARY_Index02.NDF',
	SIZE = 2048MB,
	FILEGROWTH = 512MB
) TO FILEGROUP [FG_PRIMARY_Index];
GO
...
FILE (
	...
	FILENAME = 'D:\BIDatabases\PRIMARY_Indexs_HDQ\PF_PRIMARY_Index03.NDF',
	SIZE = 2048MB,
	FILEGROWTH = 512MB
) TO FILEGROUP [FG_PRIMARY_Index];
GO
...
FILE (
	...
	FILENAME = 'D:\BIDatabases\PRIMARY_Indexs_HDQ\PF_PRIMARY_Index04.NDF',
	SIZE = 2048MB,
	FILEGROWTH = 512MB
) TO FILEGROUP [FG_PRIMARY_Index];
GO
...
FILE (
	...
	FILENAME = 'D:\BIDatabases\PRIMARY_Indexs_HDQ\PF_PRIMARY_Index05.NDF',
	SIZE = 2048MB,
	FILEGROWTH = 512MB
) TO FILEGROUP [FG_PRIMARY_Index];
GO